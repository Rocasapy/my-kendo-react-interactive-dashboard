...
import { DonutChartContainer } from './components/views/DonutChartContainer';
import { BarChartContainer } from './components/views/BartChartContainer';
          ...
          <div className="app-container container" ref={(el) => this.appContainer = el}>
            <div className="row">
              ...
              <div className="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 buttons-right">
                ...
                <Button onClick={this.handlePDFExport}>Imprimir en PDF</Button>
              </div>
            </div>
            <div className="row">
